...
export default {
  ...
  theme: {
  	extend: {
  		...
  		gradient: {
  			primary: {
  				start: 'hsl(var(--primary-gradient-1))',
  				end: 'hsl(var(--primary-gradient-2))'
  			}
  		},
  		backgroundImage: {
  			'primary-gradient': 'linear-gradient(to bottom, hsl(var(--primary-gradient-1)), hsl(var(--primary-gradient-2)))'
  		},
  		fontFamily: {
  			poppins: [
  				'var(--font-poppins)',
  		...
  		boxShadow: {
  			...
  			'custom-xl': '0 0 30px rgba(0, 0, 0, 0.2)',
  			'custom-2xl': '0 0 40px rgba(0, 0, 0, 0.1)'
  		}
  	}
  },
