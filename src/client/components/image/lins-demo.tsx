...
import { Lens } from "@/client/components/ui/lens";
import Image from "next/image";
import { motion } from "framer-motion";
import { cn } from "@/lib/utils";

export function ImageOnly({src}: {src: string}) {
      ...
      <Lens>
        <div className="relative mx-auto my-10 w-full max-w-md overflow-hidden rounded-3xl bg-gradient-to-r from-[#1D2235] to-[#121318] p-8">
          ...
          <div className="relative z-10">
            ...
            <motion.div className="relative z-20 py-4">
              <h2 className="text-left text-2xl font-bold text-white">
                Apple Vision Pro
              </h2>
              <p className="mt-4 text-left text-neutral-200">
...
const Beams = () => {
  return (
    <svg
      ...
      className="pointer-events-none absolute left-1/2 top-0 w-full -translate-x-1/2"
    >
